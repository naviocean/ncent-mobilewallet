...
import {Keyboard, Alert, Button, FlatList, TextInput, StyleSheet, Text, View,
...
import {userUpdate, createUser, tempPinEntered, pinsDontMatch, pinsDoMatch} from '../../Actions';
    ...
    if (this.props.loading) {
      ...
      return (
        <View style={{marginTop: 50}}>      
          ...
          <View style={{flexDirection: 'row', justifyContent: 'center', marginTop: 30}}>
            <Text> This can take around one minute </Text>
          </View>
        </View>
        );
    }
    ...
    return (
      ...
      <View style={styles.container}>
        <View style={styles.navBar}>
            <TouchableWithoutFeedback onPress={()=> Actions.popTo("PhoneSignup")}>
              <View>
...
module.exports = connect(mapStateToProps, {userUpdate, createUser, tempPinEntered, pinsDontMatch, pinsDoMatch})(PinSignup);