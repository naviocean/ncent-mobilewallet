    ...
    return (
      <View style={styles.container}>
        ...
        <View style={{flexDirection: 'row', paddingTop: 1, height: 1, backgroundColor: "lightgray"}}></View> 
          <TouchableHighlight onPress={() => {Actions.replace("TokensScreen"); Actions.drawerClose();}} underlayColor="lightgray">
          ...
          <View style={{flexDirection: 'row', paddingTop: 1, height: 1, backgroundColor: "lightgray"}}></View>
          <TouchableHighlight onPress={() => {Actions.replace("ShowPhrase"); Actions.drawerClose();}} underlayColor="lightgray">
            <View style={{flexDirection: 'row', paddingLeft: 15, height: 40, justifyContent: 'flex-start', alignItems:'center'}}>
              <Icon
                size={20}
                type='entypo'
          ...
          <View style={{flexDirection: 'row', paddingTop: 1, height: 1, backgroundColor: "lightgray"}}></View> 
          <TouchableHighlight onPress={() => {Actions.replace("MaitreSignup"); Actions.drawerClose();}} underlayColor="lightgray">
            <View style={{flexDirection: 'row', paddingLeft: 15, height: 40, justifyContent: 'flex-start', alignItems:'center'}}>
              <Icon
                size={20}
                type='font-awesome'
          ...
          <View style={{flexDirection: 'row', paddingTop: 1, height: 1, backgroundColor: "lightgray"}}></View>
          <TouchableHighlight onPress={() => {Actions.replace("InvestorScreen1"); Actions.drawerClose();}} underlayColor="lightgray">
            <View style={{flexDirection: 'row', paddingLeft: 15, height: 40, justifyContent: 'flex-start', alignItems:'center'}}>
              <Icon
                size={20}
                type='material-icons'
                name='people'
                color='#4c3e99' />
              <Text style={{paddingLeft: 15, fontSize: 20}}>Investors</Text>
            </View>
          </TouchableHighlight>  
