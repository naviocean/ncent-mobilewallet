...
import {Keyboard, Modal, Button, FlatList, TextInput, StyleSheet, Text, View, TouchableHighlight, TouchableOpacity, TouchableNativeFeedback, TouchableWithoutFeedback  } from 'react-native';
              ...
              <View>
                <TouchableHighlight onPress={() => Actions.TokenDetails({tokenType: item})} underlayColor="white">
                  <View style={{flexDirection: 'row', paddingTop: 30, height: 90}}>
                    <Text style={{paddingLeft: 20, fontSize: 20}}>test-{item.asset_code || item.asset_type}</Text>
                  </View>
                </TouchableHighlight>
