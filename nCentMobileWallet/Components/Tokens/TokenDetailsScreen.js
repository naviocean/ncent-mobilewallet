...
import {getTokenBalance, exitBalance} from '../../Actions';
    ...
    return (
      <View style={styles.container}>
        <View style={styles.navBar}>
          <TouchableWithoutFeedback onPress={() => {       this.goBackClear()  }}>
            <View>
...
module.exports = connect(mapStateToProps, {getTokenBalance, exitBalance})(TokenDetailsScreen);
