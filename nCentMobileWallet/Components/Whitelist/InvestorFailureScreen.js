...
// We decided not to do a fail option
class InvestorFailureScreen extends Component {
  ...
  render() {
    return (
      <View style={styles.container}>
        ...
        <View>
          <Text style={styles.informationTextBold}> Sorry, you are not authorized to be an investor. </Text>
...
module.exports = connect(mapStateToProps)(InvestorFailureScreen);
